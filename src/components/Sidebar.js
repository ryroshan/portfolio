...
const Sidebar = () => {
    const handleEmailMe = () => {
        window.open("mailto:ryroshan9@gmail.com")
    }
        ...
        >
            ...
            <div className="sidebar__contact">
                <div className="sidebar__item sidebar__github">
                    <a href="https://github.com/ryroshan" target='_blank' rel="noreferrer"><img src={github} alt="github" className="sidebar__icon mr-3" />github</a>
                </div>
                <div className="sidebar__location">
                    <img src={pin} alt="location" className="sidebar__icon mr-3" />
                    Bangalore, India</div>
                <div className="sidebar__item">ryroshan9@gmail.com</div>
                <div className="sidebar__item">8954179376</div>
            </div>
